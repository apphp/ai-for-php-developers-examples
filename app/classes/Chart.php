                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            tooltip: {
                                callbacks: {
                                    label: function(context) {
                                        const xLabel = '" . addslashes($xLabel) . "';
                                        if (context.datasetIndex === 0) {
                                            return xLabel + ': ' + context.parsed.x + ', Price: $' + context.parsed.y.toLocaleString();
                                        }
                                        return '" . $yLabel . ": $' + Math.round(context.parsed.y).toLocaleString();
                                    }
                                }
                            }
                        },
                        scales: {
                            x: {
                                type: 'linear',
                                position: 'bottom',
                                " . ($minX != 0 ? 'beginAtZero: false, min: ' . $minX . ',' : '') . "
                                title: {
                                    display: true,
