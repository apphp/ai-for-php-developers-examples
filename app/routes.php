...
$app->group('/part-2', function ($app) use ($renderer): void {
    ...
    $app->group('/linear-regression-as-basic-model', function ($app) use ($renderer): void {
        ...
        $app->get('/case-5/market-salary-forecast', function (Request $request, Response $response) use ($renderer): Response {
            $breadcrumbs = [
                ['label' => __t('nav.home'), 'url' => APP_URL],
                ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
                ['label' => __t('linear_regression.heading'), 'url' => APP_URL . 'part-2/linear-regression-as-basic-model'],
                ['label' => __t('linear_regression.case5_title'), 'url' => null],
            ];

            return render_page($renderer, $response, $breadcrumbs, 'part-2/linear-regression-as-basic-model/market-salary-forecast/index.php');
        });
        $app->get('/case-5/market-salary-forecast/code-run', function (Request $request, Response $response) use ($renderer): Response {
            $breadcrumbs = [
                ['label' => __t('nav.home'), 'url' => APP_URL],
                ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
                ['label' => __t('linear_regression.heading'), 'url' => APP_URL . 'part-2/linear-regression-as-basic-model'],
                ['label' => __t('linear_regression.case5_title'), 'url' => APP_URL . 'part-2/linear-regression-as-basic-model/case-5/market-salary-forecast'],
                ['label' => __t('nav.code_run'), null],
            ];

            return render_page($renderer, $response, $breadcrumbs, 'part-2/linear-regression-as-basic-model/market-salary-forecast/code-run.php');
        });
    });
