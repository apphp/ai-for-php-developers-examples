...
$app->group('/part-1', function ($app) use ($renderer): void {
    $app->get('/what-is-a-model', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
    ...
    $app->get('/what-is-a-model/function-as-the-model', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part1_title'), 'url' => APP_URL . 'part-1/what-is-a-model'],
    ...
    $app->get('/what-is-a-model/function-as-the-model/code-run', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part1_title'), 'url' => APP_URL . 'part-1/what-is-a-model'],
            ['label' => __t('nav.part1_what_is_model'), 'url' => APP_URL . 'part-1/what-is-a-model'],
    ...
    $app->get('/what-is-a-model/error-as-measure-of-quality', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part1_title'), 'url' => APP_URL . 'part-1/what-is-a-model'],
            ['label' => __t('nav.part1_what_is_model'), 'url' => APP_URL . 'part-1/what-is-a-model'],
    ...
    $app->get('/what-is-a-model/error-as-measure-of-quality/code-run', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part1_title'), 'url' => APP_URL . 'part-1/what-is-a-model'],
            ['label' => __t('nav.part1_what_is_model'), 'url' => APP_URL . 'part-1/what-is-a-model'],
...
$app->group('/part-2', function ($app) use ($renderer): void {
    $app->get('/errors-and-loss-functions', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
    ...
    $app->get('/errors-and-loss-functions/case-1/mse-and-cost-of-a-big-miss', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
    ...
    $app->get('/errors-and-loss-functions/case-1/mse-and-cost-of-a-big-miss/code-run', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
            ['label' => __t('nav.part2_error_loss_functions'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
    ...
    $app->get('/linear-regression-as-basic-model', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
    ...
    $app->get('/linear-regression-as-basic-model/case-1/apartment-valuation-based-on-parameters', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
    ...
    $app->get('/linear-regression-as-basic-model/case-1/apartment-valuation-based-on-parameters/code-run', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
            ['label' => __t('linear_regression.heading'), 'url' => APP_URL . 'part-2/linear-regression-as-basic-model'],
    ...
    $app->get('/linear-regression-as-basic-model/case-1/apartment-valuation-based-on-parameters/rubix-code-run', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
            ['label' => __t('linear_regression.heading'), 'url' => APP_URL . 'part-2/linear-regression-as-basic-model'],
    ...
    $app->get('/gradient-descent-on-fingers', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
    ...
    $app->get('/gradient-descent-on-fingers/implementation', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
    ...
    $app->get('/gradient-descent-on-fingers/implementation/code-run', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part2_title'), 'url' => APP_URL . 'part-2/errors-and-loss-functions'],
            ['label' => __t('gradient_descent.heading'), 'url' => APP_URL . 'part-2/gradient-descent-on-fingers/implementation'],
...
$app->group('/part-3', function ($app) use ($renderer): void {
    $app->get('/probability-as-degree-of-confidence', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
    ...
    $app->get('/probability-as-degree-of-confidence/implementation', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part3_title'), 'url' => APP_URL . 'part-3/probability-as-degree-of-confidence'],
    ...
    $app->get('/probability-as-degree-of-confidence/implementation/code-run', function (Request $request, Response $response) use ($renderer): Response {
        $breadcrumbs = [
            ['label' => __t('nav.home'), 'url' => APP_URL],
            ['label' => __t('nav.part3_title'), 'url' => APP_URL . 'part-3/probability-as-degree-of-confidence'],
            ['label' => __t('nav.part3_probability_confidence'), 'url' => APP_URL . 'part-3/probability-as-degree-of-confidence/implementation'],
