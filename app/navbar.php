    ...
    <div class="position-sticky pt-3">
        ...
        <div id="navbar" class="<?= $sideBar === 'collapsed' ? 'nonvisible' : ''; ?>">
            ...
            <ul class="nav flex-column mb-2">
                ...
                <li class="nav-item">
                    <a class="nav-link<?= str_starts_with($currentPath, $linkPath = '/part-1/vectors-dimensions-and-feature-spaces') ? ' active' : '' ?>" href="<?=APP_URL . ltrim($linkPath, '/')?>">
            ...
            <ul class="nav flex-column mb-2">
                ...
                <li class="nav-item">
                    <a class="nav-link<?= str_starts_with($currentPath, $linkPath = '/part-5/bag-of-words-and-tf-idf') ? ' active' : '' ?>" href="<?=APP_URL . ltrim($linkPath, '/')?>">
