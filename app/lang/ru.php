...
return [
    ...
    'gradient_descent.implementation_intro' => 'В этом разделе мы реализуем градиентный спуск на PHP: сначала минимальную версию «с нуля», затем — более удобную векторную форму. Используйте кнопки запуска, чтобы выполнить код и поэкспериментировать с параметрами.',
