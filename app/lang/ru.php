...
return [
    ...
    'gradient_descent.animation_intro' => 'Ниже — небольшая интерактивная анимация градиентного спуска в 1D и 2D. Настройте скорость обучения и стартовую точку, нажмите «Старт» и посмотрите, как параметры движутся к минимуму, а ошибка уменьшается.',
