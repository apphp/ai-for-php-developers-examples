...
return [
    ...
    'gradient_descent.animation.ui.start' => 'Старт',
    'gradient_descent.animation.ui.pause' => 'Пауза',
    'gradient_descent.animation.ui.reset' => 'Сброс',
    ...
    'gradient_descent.animation.ui.grad_1d' => 'где <code>∇f(x) = 2(x - a)</code>',
    'gradient_descent.animation.ui.grad_2d' => 'где <code>∇f(x,y) = (2(x-a), 2(y-b))</code>',
    'gradient_descent.animation.ui.grad_3d' => 'где <code>∇f(x,y,z) = (2(x-a), 2(y-b), 2(z-c))</code>',
    'gradient_descent.animation.ui.trajectory' => 'Траектория',
    'gradient_descent.animation.ui.trajectory_hint_1d' => 'Точка движется к минимуму (вертикальная линия — <code>a</code>).',
    'gradient_descent.animation.ui.trajectory_hint_2d' => 'Точка движется к минимуму (цель — точка <code>(a,b)</code>).',
    'gradient_descent.animation.ui.trajectory_hint_3d' => '3D: точка движется к цели <code>(a,b,c)</code> в пространстве <code>(x,y,z)</code>.',
    'gradient_descent.animation.ui.trajectory_hint_3d_surface' => '3D поверхность: путь показан на поверхности \(z=f(x,y)\), а \((x,y)\) движется к цели <code>(a,b)</code>.',
    'gradient_descent.animation.ui.loss_chart' => 'График ошибки',
    'gradient_descent.animation.ui.loss_chart_hint' => 'На графике: значение <code>f</code> по итерациям. Если <code>α</code> слишком большое — возможны колебания.',
    ...
    'gradient_descent.sample1.ui.play' => 'Запуск',
    'gradient_descent.sample1.ui.pause' => 'Пауза',
