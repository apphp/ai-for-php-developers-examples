...
return [
    ...
    'gradient_descent.animation.ui.objective_3d' => 'Визуализируем поверхность \(z = f(x,y)\), где \(f(x,y) = (x - a)^2 + (y - b)^2\)',
    ...
    'gradient_descent.animation.ui.trajectory_hint_3d' => '3D: на плоскости показано движение по <code>(x,y)</code>, а ниже — отдельная шкала для <code>z</code>.',
