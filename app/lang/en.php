...
return [
    ...
    'gradient_descent.animation.ui.start' => 'Start',
    'gradient_descent.animation.ui.pause' => 'Pause',
    'gradient_descent.animation.ui.reset' => 'Reset',
    ...
    'gradient_descent.animation.ui.grad_1d' => 'where <code>∇f(x) = 2(x - a)</code>',
    'gradient_descent.animation.ui.grad_2d' => 'where <code>∇f(x,y) = (2(x-a), 2(y-b))</code>',
    'gradient_descent.animation.ui.grad_3d' => 'where <code>∇f(x,y,z) = (2(x-a), 2(y-b), 2(z-c))</code>',
    'gradient_descent.animation.ui.trajectory' => 'Trajectory',
    'gradient_descent.animation.ui.trajectory_hint_1d' => 'The point moves toward the minimum (the vertical line is <code>a</code>).',
    'gradient_descent.animation.ui.trajectory_hint_2d' => 'The point moves toward the minimum (target point <code>(a,b)</code>).',
    'gradient_descent.animation.ui.trajectory_hint_3d' => '3D: the point moves toward the target <code>(a,b,c)</code> in the <code>(x,y,z)</code> space.',
    'gradient_descent.animation.ui.trajectory_hint_3d_surface' => '3D surface: the path is shown on the surface \(z=f(x,y)\) while \((x,y)\) moves toward <code>(a,b)</code>.',
    'gradient_descent.animation.ui.loss_chart' => 'Loss chart',
    'gradient_descent.animation.ui.loss_chart_hint' => 'The chart shows the value of <code>f</code> over iterations. If <code>α</code> is too large, you may see oscillations.',
