...
return [
    ...
    'gradient_descent.run_animation' => 'Run animation',
    'gradient_descent.animation_title' => 'Implementation of gradient descent (animation)',
    'gradient_descent.animation_gd_title' => 'Gradient descent (animation)',
    'gradient_descent.animation_intro' => 'Below is a small interactive animation of gradient descent in 1D, 2D and 3D. Tune the learning rate and starting point, press Start, and watch how the parameters move toward the minimum while the loss decreases.',
    'gradient_descent.animation.back_to_toc' => '← Back to contents',
    'gradient_descent.animation.ui.parameters' => 'Parameters',
    'gradient_descent.animation.ui.objective_1d' => 'We minimize \(f(x) = (x - a)^2\)',
    'gradient_descent.animation.ui.objective_2d' => 'We minimize \(f(x,y) = (x - a)^2 + (y - b)^2\)',
    'gradient_descent.animation.ui.objective_3d' => 'We minimize \(f(x,y,z) = (x - a)^2 + (y - b)^2 + (z - c)^2\)',
    'gradient_descent.animation.ui.objective_3d_surface' => 'We visualize the surface \(z = f(x,y)\), where \(f(x,y) = (x - a)^2 + (y - b)^2\)',
    'gradient_descent.animation.ui.mode' => 'Mode',
    'gradient_descent.animation.ui.learning_rate' => 'Learning rate (α)',
    'gradient_descent.animation.ui.start_x' => 'Start x',
    'gradient_descent.animation.ui.start_y' => 'Start y',
    'gradient_descent.animation.ui.start_z' => 'Start z',
    'gradient_descent.animation.ui.target_a' => 'Target a (minimum by x)',
    'gradient_descent.animation.ui.target_b' => 'Target b (minimum by y)',
    'gradient_descent.animation.ui.target_c' => 'Target c (minimum by z)',
    'gradient_descent.animation.ui.speed' => 'Speed (steps/sec)',
    'gradient_descent.animation.ui.iteration' => 'Iteration',
    'gradient_descent.animation.ui.current_x' => 'Current x',
    'gradient_descent.animation.ui.current_y' => 'Current y',
    'gradient_descent.animation.ui.current_z' => 'Current z',
    'gradient_descent.animation.ui.fx' => '$    f(x)$',
    'gradient_descent.animation.ui.grad_abs' => '$|∇f|$',
    'gradient_descent.animation.ui.update_rule' => 'Update rule:',
    'gradient_descent.animation.ui.grad_1d' => 'where $∇f(x) = 2(x - a)$',
    'gradient_descent.animation.ui.grad_2d' => 'where $∇f(x,y) = (2(x-a), 2(y-b))$',
    'gradient_descent.animation.ui.grad_3d' => 'where $∇f(x,y,z) = (2(x-a), 2(y-b), 2(z-c))$',
    'gradient_descent.animation.ui.trajectory' => 'Trajectory',
    'gradient_descent.animation.ui.trajectory_hint_1d' => 'The point moves toward the minimum (the vertical line is $a$).',
    'gradient_descent.animation.ui.trajectory_hint_2d' => 'The point moves toward the minimum (target point $(a,b)$).',
    'gradient_descent.animation.ui.trajectory_hint_3d' => '3D: the point moves toward the target $(a,b,c)$ in the $(x,y,z)$ space.',
    'gradient_descent.animation.ui.trajectory_hint_3d_surface' => '3D surface: the path is shown on the surface \(z=f(x,y)\) while \((x,y)\) moves toward $(a,b)$.',
    'gradient_descent.animation.ui.loss_chart' => 'Loss chart',
    'gradient_descent.animation.ui.loss_chart_hint' => 'The chart shows the value of $f$ over iterations. If $α$ is too large, you may see oscillations.',
    'gradient_descent.animation.ui.chart_iteration' => 'iteration',
    ...
    'gradient_descent.sample2.intro' => 'In this example we run the same gradient descent with different learning rate values and compare how the parameter $w$ changes.',
    'gradient_descent.sample2.goal' => 'The goal is to see the difference between a step that is too small, a normal step, and a step that is too large and causes divergence.',
    'gradient_descent.sample2.compare_label' => 'We compare the following learning rates:',
    'gradient_descent.sample2.run_intro' => 'Below you can see how the parameter $w$ behaves for three learning rate values on the same dataset.',
    'gradient_descent.sample2.lr_slow' => 'too small a step: training progresses slowly.',
    'gradient_descent.sample2.lr_good' => 'a normal step: the parameter quickly approaches the correct value.',
    'gradient_descent.sample2.lr_diverge' => 'too large a step: the updates become unstable and diverge.',
    ...
    'probability_confidence.case3.scenario_title' => 'Scenario',
    'probability_confidence.case3.scenario_intro' => 'We have a model that must distinguish three types of emails: normal, promo, and spam. Each email uses two simple features: subject length and number of links.',
    'probability_confidence.case3.scenario_note' => 'Unlike binary classification, here the model must distribute confidence across several classes at once. That is exactly why SoftmaxClassifier is useful.',
