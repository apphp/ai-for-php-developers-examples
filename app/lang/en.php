...
return [
    ...
    'gradient_descent.animation.ui.objective_3d' => 'We visualize the surface \(z = f(x,y)\), where \(f(x,y) = (x - a)^2 + (y - b)^2\)',
    ...
    'gradient_descent.animation.ui.trajectory_hint_3d' => '3D: the plane shows movement in <code>(x,y)</code>, and below is a separate track for <code>z</code>.',
