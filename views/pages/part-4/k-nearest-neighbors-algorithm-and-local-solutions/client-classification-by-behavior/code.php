...
// k-Nearest Neighbors (k-NN) from scratch: classify a new customer by behavior.
...
// Here features are just two numbers (e.g. activity and spending), labels are behavior segments.
$dataset = [
    [[5, 2.1], 'casual'],
    [[3, 1.8], 'casual'],
    [[10, 6.5], 'engaged'],
