<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><?= __t('home.heading'); ?></h1>
</div>
...
<hr>
<div>
    <p><i style="color:darkorange; font-size: 15px;">⚠️</i> <b><?= __t('home.disclaimer_title'); ?></b></p>

    <p><?= __t('home.disclaimer_p1'); ?></p>

    <p><?= __t('home.disclaimer_p2'); ?></p>

    <p><b><?= __t('home.disclaimer_p3'); ?></b></p>
</div>
