...
1. Clone the repository:
  ```
  git@github.com:apphp/ai-for-php-developers-examples.git
  ```
3. Navigate to the project directory:
  ```
  cd ai-for-php-developers-examples
  ```
